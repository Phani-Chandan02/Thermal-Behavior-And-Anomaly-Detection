...
# CONFIG
# ============================
INPUT_FOLDER = "data/raw_images/thermal_temperature_images_own"
OUTPUT_FOLDER = "output/analyzed_images/thermal_temperature_analyzed"
RESULTS_FILE = "output/logs/thermal_temperature_results.csv"
...
# MAIN PROCESSING
# ============================
print("[INFO] Analyzing thermal temperature signatures from images...\n")
...
print("\n" + "="*60)
print("[SUCCESS] THERMAL TEMPERATURE ANALYSIS COMPLETE")
print("="*60)
