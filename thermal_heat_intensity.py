...
# CONFIG
# ============================
INPUT_FOLDER = "thermal_heat_images"  # Folder with thermal images
OUTPUT_FOLDER = "thermal_heat_analyzed"  # Output folder for results
RESULTS_FILE = "thermal_heat_results.txt"
...
# MAIN PROCESSING
# ============================
print("🔥 Analyzing thermal heat intensity from images...\n")
...
print("\n" + "="*60)
print("✅ THERMAL HEAT INTENSITY ANALYSIS COMPLETE")
print("="*60)
